...
const Home = () => {
  ...
  else if (location.pathname.includes('/stock-adjustment-form')) currentModule = "Stock Movement"
  else if (location.pathname.includes('/stock-adjustments')) currentModule = "Stock Movement"
